...
(x_train, y_train) = (pickle.load(open('sift/xtrain_sift.pickle', 'rb')), pickle.load(open('sift/ytrain_sift.pickle', 'rb')))
(x_test, y_test) = (pickle.load(open('sift/xtest_sift.pickle', 'rb')), pickle.load(open('sift/ytest_sift.pickle', 'rb')))
